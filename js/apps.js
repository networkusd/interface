...
const sttaddr = "0x6a44538a9cff29a17fd2ca4d5c778f06357c51dd";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x6a44538a9cff29a17fd2ca4d5c778f06357c51dd";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://gusd.network?ref=' + document.getElementById('refaddress').value;
        }
    }
}
